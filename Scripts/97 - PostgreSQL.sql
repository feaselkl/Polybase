...
## Issues
https://community.denodo.com/answers/question/details?questionId=9060g0000004FRYAA2&title=Errors+with+ODBC+client+connection+from+SQL+Server+Polybase
You might not be able to use tables in Postgres with data type NUMERIC.
*/
