...
BEGIN
	...
	(
		...
		[EditDate] [datetime2](7) NULL,
		[Editor] [nvarchar](50) NULL,
		DispatchYear INT NULL
	) ON [PRIMARY];

	INSERT INTO dbo.FireIncidentsLocal
	SELECT *, YEAR(dispatch_date_time) FROM dbo.FireIncidentsBackup;

	CREATE UNIQUE CLUSTERED INDEX [IX_FireIncidentsLocal_Year] ON dbo.FireIncidentsLocal(DispatchYear, OBJECTID);
END
GO
